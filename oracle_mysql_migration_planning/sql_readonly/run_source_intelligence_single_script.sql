...
--
-- Usage:
--   @run_source_intelligence_single_script.sql SCHEMA_FILTER REPORT_DIR SOURCE_DB_VERSION SOURCE_VCPUS SOURCE_SGA_GB SOURCE_PGA_LIMIT_GB
--
-- Example:
--   @run_source_intelligence_single_script.sql HR /tmp/oracle_source_intel 19c 8 350 40
--
-- Notes:
